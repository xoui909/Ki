...
<head>
<meta charset="UTF-8">
<title>W I S H</title>here</title>
...
<script type="text/javascript">
function highlight() {
	var keyword = ${search_key};
	var new_keyword = "<u>"+keyword+"</u>";
	var str = document.getElementById("test").innerHTML;
	var res = str.replace(keyword, new_keyword);
		...
		<!-- 전체 글 박스 -->
			<ul class="post-box" id="post-box">
				...
				<li>
					...
					<input type="hidden" name="search_key2" value="${search_key }">
